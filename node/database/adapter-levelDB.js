...
var _LevelStore = (function () {
    ...
    _LevelStore.prototype.rangeRead = function (table, rowCallback, complete, fromIdx, toIdx) {
        ...
        var rows = [];
        var lower = keys[ranges[0]];
        var higher = keys[ranges[1]];
    ...
    _LevelStore.prototype.getIndex = function (table, getIdx, complete) {
        complete(getIdx ? this._dbIndex[table].keys().length : this._dbIndex[table].keys());
    };
    _LevelStore.prototype.indexOfPK = function (table, pk, complete) {
