...
var _NanoSQLStorage = (function () {
    ...
    _NanoSQLStorage.prototype._rangeRead = function (table, fromIdx, toIdx, complete) {
        var rows = [];
    ...
    _NanoSQLStorage.prototype._write = function (table, pk, oldRow, newRow, complete) {
        ...
        if (!oldRow) {
            ...
            var setRow_1 = __assign({}, oldRow, newRow);
            var sameKeys_1 = Object.keys(setRow_1).filter(function (key) {
                return setRow_1[key] === oldRow[key];
            });
            this._clearSecondaryIndexes(table, oldRow[this.tableInfo[table]._pk], oldRow, sameKeys_1, function () {
                _this._setSecondaryIndexes(table, oldRow[_this.tableInfo[table]._pk], setRow_1, sameKeys_1, function () {
                    _this._adapter.write(table, oldRow[_this.tableInfo[table]._pk], setRow_1, complete, true);
                });
            });
        }
    };
