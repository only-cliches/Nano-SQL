...
var _NanoSQLStorageQuery = /** @class */ (function () {
    ...
    _NanoSQLStorageQuery.prototype._getRows = function (complete) {
        if (this._isInstanceTable) {
            ...
            new _RowSelection(this._query, this._store, function (rows) {
...
var _RowSelection = /** @class */ (function () {
    function _RowSelection(q, s, callback) {
        var _this = this;
        this.q = q;
        this.s = s;
...
var _where = function (singleRow, where, rowIDX, ignoreFirstPath) {
    ...
    if (typeof where[0] !== "string") { // compound where statements
        ...
        var checkWhere_1 = where.map(function (wArg, idx) {
            if (commands.indexOf(wArg) !== -1) {
                ...
                return _compare(wArg[2], wArg[1], utilities_1.objQuery(wArg[0], singleRow, ignoreFirstPath)) === 0 ? true : false;
            }
        });
        ...
        checkWhere_1.forEach(function (wArg, idx) {
            if (wArg === "OR") {
        ...
        return checkWhere_1.indexOf(false) === -1;
        /*
        ...
        return _compare(where[2], where[1], utilities_1.objQuery(where[0], singleRow, ignoreFirstPath)) === 0 ? true : false;
    }
};
/**
