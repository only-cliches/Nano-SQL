                    ...
                    utilities_1.fastALL(Object.keys(reduceWords), function (word, k, nextWord) {
                        ...
                        utilities_1.fastALL(["_search_", "_search_fuzzy_"], function (tableSection, l, next) {
                            ...
                            _this._store.adapterRead("_" + table + tableSection + col, indexWord, function (colRow) {
                                ...
                                _this._store.adapterWrite("_" + table + tableSection + col, l === 0 ? word : wordCache[word], searchIndex, next, function () { }, true);
                            }, true);
                        }).then(nextWord);
                    }).then(nextTokens);
                }).then(function () {
            ...
            utilities_1.fastALL(_this._store.tableInfo[_this._query.table]._viewTables, function (view, i, rowDone) {
                ...
                _this._store._secondaryIndexRead(view.table, "=", view.column, row[pk], function (relatedRows) {
                    ...
                    utilities_1.fastALL(relatedRows, function (rRow, j, rDone) {
                        ...
                        _this._store.adapterWrite(view.table, rRow[rPk], rRow, rDone, function () { }, true);
                    }).then(rowDone);
                }, true);
            }).then(done);
        }).then(complete);
                        ...
                        utilities_1.fastCHAIN(rows, function (r, i, rowDone) {
                            _this._updateSearchIndex(r[pk], r, function () {
                                _this._updateRowViews(inputData || {}, r, function (updatedRowData) {
                                    ...
                                    _this._store._write(_this._query.table, r[pk], r, updatedRowData, rowDone, true);
                                });
                            });
                        }).then(function (nRows) {
                            newRows_1 = nRows;
