...
var NanoSQLDefaultBackend = /** @class */ (function () {
    ...
    NanoSQLDefaultBackend.prototype.willConnect = function (connectArgs, next) {
        ...
        for (var i = 0; i < 100; i++) {
            this._queryPool.push(new query_1._NanoSQLStorageQuery(this._store));
        }
    ...
    NanoSQLDefaultBackend.prototype.dumpTables = function (tables) {
        ...
        return new utilities_1.Promise(function (res, rej) {
            ...
            utilities_1.fastALL(exportTables, function (table, i, done) {
                dump[table] = [];
                _this._store._adapter.rangeRead(table, function (r, idx, rowDone) {
                    dump[table].push(r);
                    rowDone();
                }, done);
            }).then(function () {
        ...
        return new utilities_1.Promise(function (res, rej) {
            utilities_1.fastALL(Object.keys(tables), function (tableName, i, done) {
                ...
                utilities_1.fastALL(tables[tableName], function (row, i, done) {
                    _this._store._adapter.write(tableName, row[pkKey], row, done, true);
                }).then(done);
            }).then(function () {
                res();
            });
    ...
    NanoSQLDefaultBackend.prototype.extend = function (next, args, result) {
        ...
        switch (args[0]) {
            case "clone":
                ...
                Object.keys(this.parent._models).forEach(function (table) {
                    nSQLi_1.table(table).model(_this.parent._models[table], [], true);
                });
                nSQLi_1
                    .config({
                    id: this._store._id,
                    ...
                    var i = 0;
                    utilities_1.fastCHAIN(Object.keys(_this.parent._models), function (table, i, done) {
