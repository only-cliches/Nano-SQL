...
var _NanoSQLStorage = /** @class */ (function () {
    ...
    _NanoSQLStorage.prototype._write = function (table, pk, oldRow, newRow, complete) {
        var _this = this;
        if (!oldRow) { // new row
            utilities_1.fastALL([0, 1], function (idx, i, next) {
                switch (idx) {
                    case 0:
                        _this.adapterWrite(table, pk, newRow, next);
                        break;
                    case 1:
                        if (_this.tableInfo[table]._secondaryIndexes.length) {
                            _this._setSecondaryIndexes(table, newRow[_this.tableInfo[table]._pk], newRow, [], next);
                        }
                        else {
                            next();
                        }
            ...
            if (this.tableInfo[table]._secondaryIndexes.length) {
                utilities_1.fastALL([0, 1, 2], function (idx, i, next) {
                    switch (idx) {
                        case 0:
                            _this._clearSecondaryIndexes(table, pk, oldRow, sameKeys_1, next);
                            break;
                        case 1:
                            _this._setSecondaryIndexes(table, pk, setRow_1, sameKeys_1, next);
                            break;
                        case 2:
