                ...
                var completeConnect = function () {
                    utilities_1.fastALL(t.plugins, function (p, i, nextP) {
                        ...
                        if (_this.peerMode) {
                            ...
                            var getPeers_1 = function () { return JSON.parse(localStorage.getItem("nsql-peers-" + _this.id) || "[]"); };
                            _this.peers = getPeers_1();
                            ...
                            window.addEventListener("storage", function (e) {
                                ...
                                if (e.key && e.key.indexOf(_this.pid + ".") === 0) {
                                    ...
                                    _this.peerEvents.push(ev.query.queryID || "");
                                    _this.triggerEvent(ev);
                                }
