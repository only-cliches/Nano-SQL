...
var NanoSQLInstance = /** @class */ (function () {
    ...
    NanoSQLInstance.prototype.connect = function () {
        ...
        return new utilities_1.Promise(function (res, rej) {
            ...
            utilities_1.fastCHAIN(_this._plugins, function (p, i, nextP) {
                ...
                _this.dataModels = connectArgs.models;
                _this._actions = connectArgs.actions;
                _this._views = connectArgs.views;
                _this._config = connectArgs.config;
                Object.keys(_this.dataModels).forEach(function (table) {
                    var hasWild = false;
                    _this.dataModels[table] = _this.dataModels[table].filter(function (model) {
                ...
                t._tableNames = Object.keys(_this.dataModels);
                var completeConnect = function () {
                    utilities_1.fastALL(_this._plugins, function (p, i, nextP) {
                        ...
                        if (_this._onConnectedCallBacks.length) {
                            _this._onConnectedCallBacks.forEach(function (cb) { return cb(); });
                        }
                        res(t._tableNames);
                    });
                };
    ...
    NanoSQLInstance.prototype.query = function (action, args) {
        ...
        var av = t._activeAV;
        t._activeAV = undefined;
        return new std_query_1._NanoSQLQuery(this).set(this.sTable, action, args, av);
    };
    ...
    NanoSQLInstance.prototype.rawDump = function (tables) {
        ...
        return new utilities_1.Promise(function (res, rej) {
            var result = {};
            utilities_1.fastCHAIN(_this._plugins, function (plugin, i, next) {
     ...
     * @memberof NanoSQLInstance
     */
    NanoSQLInstance.prototype.rawImport = function (tables) {
        var _this = this;
        return new utilities_1.Promise(function (res, rej) {
            utilities_1.fastCHAIN(_this._plugins, function (plugin, i, next) {
     ...
     * @memberOf NanoSQLInstance
     */
    NanoSQLInstance.prototype.loadCSV = function (table, csv, useTransaction, rowFilter) {
        var _this = this;
        if (useTransaction === void 0) { useTransaction = true; }
        var t = this;
        var fields = [];
            ...
            if (k === 0) {
                ...
                while (i--) {
                    if (row_1[i].indexOf("{") === 1 || row_1[i].indexOf("[") === 1) {
                        ...
                        row_1[i] = row_1[i].slice(1, row_1[i].length - 1);
                    }
