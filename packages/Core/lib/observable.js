...
var Observer = /** @class */ (function () {
    ...
    Observer.prototype.subscribe = function (callback) {
        ...
        var complete;
        var lastCount = {};
        return new interfaces_1.INanoSQLObserverSubscriber(this._nSQL, this._query, {
...
var ObserverSubscriber = /** @class */ (function () {
    function ObserverSubscriber(_nSQL, _getQuery, _callback, _tables) {
        ...
        this._tables.forEach(function (table) {
            _this._nSQL.selectTable(table).on("change", _this.exec);
        });
    }
    ...
    ObserverSubscriber.prototype.unsubscribe = function () {
        var _this = this;
        this._tables.forEach(function (table) {
            _this._nSQL.selectTable(table).off("change", _this.exec);
        });
        this._closed = true;
    };
