...
/***/ function(module, exports, __webpack_require__) {
	...
	var someSQL_Instance = (function () {
	    function someSQL_Instance(backend) {
	        var t = this;
	        if (backend) {
	            t.connect(backend);
	        }
	        else {
	            t.connect(new Some_SQL_Memory_1.someSQL_MemDB(t));
	        }
	        t._callbacks = { "*": {} };
	        t._actions = {};
	        t._views = {};
	    ...
	    someSQL_Instance.prototype.uuid = function (inputUUID) {
...
/***/ function(module, exports) {
	...
	/***/ function(module, exports, __webpack_require__) {
		...
		var some_sql_1 = __webpack_require__(1);
		var typescript_promise_1 = __webpack_require__(2);
		var someSQL_MemDB = (function (_super) {
		    __extends(someSQL_MemDB, _super);
		    function someSQL_MemDB(p) {
		    ...
		    someSQL_MemDB.prototype.newModel = function (table, args) {
	...
	/***/ function(module, exports) {
		...
		/***/ function(module, exports, __webpack_require__) {
			...
			exports.someSQL_Instance = someSQL_Instance;
			var someSQL_Backend = (function () {
			    function someSQL_Backend(parent) {
			        this.parent = parent;
			    }
			    someSQL_Backend.prototype.newModel = function (table, args) { };
			    someSQL_Backend.prototype.exec = function (table, query, callback) {
			        callback();
			    };
			    someSQL_Backend.prototype.custom = function (command, args, callback) {
			        callback();
			    };
			    return someSQL_Backend;
			}());
			exports.someSQL_Backend = someSQL_Backend;
			var someSQL_Promise = (function (_super) {
			    __extends(someSQL_Promise, _super);
			    function someSQL_Promise(scope, callBackFunc) {
			        var _this = _super.call(this, callBackFunc) || this;
